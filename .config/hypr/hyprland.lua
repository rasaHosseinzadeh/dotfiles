local mod, terminal, alt_terminal = "SUPER", "alacritty", "ghostty"
...
local function assign_monitor(monitor)
    if monitor_slots[monitor.name] then return end
...
for _, monitor in ipairs(monitors) do assign_monitor(monitor) end
...
run(mod .. " + ALT + RETURN", alt_terminal)
run(mod .. " + ALT + M", "bm-mount")
run(mod .. " + ALT + U", "bm-umount")
run(mod .. " + ALT + Q", "bm-off")
run(mod .. " + ALT + P", "keepassxc")
run(mod .. " + ALT + V", terminal .. " -e wiremix")
run(mod .. " + ALT + B", "sudo systemctl is-active --quiet bluetooth && sudo systemctl stop bluetooth || sudo systemctl start bluetooth")
run(mod .. " + CTRL + M", terminal .. " -e ncmpcpp")
run(mod .. " + ALT + S", "bm-scrot")
run(mod .. " + S", "scrot")
run(mod .. " + SHIFT + H", alt_terminal .. " -e yazi")
