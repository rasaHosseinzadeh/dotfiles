...
run("XF86MonBrightnessDown", "brightnessctl set 5%-", repeating)
run("XF86MonBrightnessUp", "brightnessctl set +5%", repeating)
run("SHIFT + XF86MonBrightnessDown", "brightnessctl set 1%-", repeating)
run("SHIFT + XF86MonBrightnessUp", "brightnessctl set +1%", repeating)
